...
Public Class frmCadPedido
    ...
    Private Sub txtValorDistribuido_EditValueChanged(sender As Object, e As EventArgs) Handles txtValorDistribuido.EditValueChanged

    End Sub

    Private Sub txtPorcentagem_EditValueChanged(sender As Object, e As EventArgs) Handles txtPorcentagem.EditValueChanged

    End Sub

    Private Sub txtTotalDesconto_EditValueChanged(sender As Object, e As EventArgs) Handles txtTotalDesconto.EditValueChanged

    End Sub

    Private Sub txtValorDistribuido_LocationChanged(sender As Object, e As EventArgs) Handles txtValorDistribuido.LocationChanged

    End Sub

    Private Sub btnPesquisarNome_EditValueChanged(sender As Object, e As EventArgs) Handles btnPesquisarNome.EditValueChanged
    ...
    Private Sub tabDadosHistorico_Click(sender As Object, e As EventArgs) Handles tabDadosHistorico.Click
    ...
    Private Sub btnOrdem_EditValueChanged(sender As Object, e As EventArgs) Handles btnOrdem.EditValueChanged

    End Sub

    Private Sub txtValorFrete_EditValueChanged(sender As Object, e As EventArgs) Handles txtValorFrete.EditValueChanged
